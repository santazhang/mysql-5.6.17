...
IF(UNIX)  
  ...
  IF(CMAKE_COMPILER_IS_GNUCXX)
    SET(COMMON_CXX_FLAGS               "-g -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -std=c++0x")
    # Disable inline optimizations for valgrind testing to avoid false positives
    IF(WITH_VALGRIND)
  ...
  IF(APPLE)
    ...
    SET(COMMON_CXX_FLAGS               "-g -fno-strict-aliasing -std=c++0x -stdlib=libc++ -Wno-c++11-narrowing -Wno-reserved-user-defined-literal")
    SET(CMAKE_C_FLAGS_DEBUG            "${COMMON_C_FLAGS}")
    SET(CMAKE_CXX_FLAGS_DEBUG          "${COMMON_CXX_FLAGS}")
